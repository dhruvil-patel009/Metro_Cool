  ...
  return (
    <div className="p-6 max-w-[1400px] mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="ghost"
                    size="icon"
                    className="absolute top-2 right-2 bg-white hover:bg-gray-100 rounded-full w-8 h-8"
                  >
        ...
        <div className="bg-white rounded-lg border-2 border-dashed border-gray-300 hover:border-cyan-400 transition-colors cursor-pointer flex flex-col items-center justify-center p-8 min-h-[320px]">
