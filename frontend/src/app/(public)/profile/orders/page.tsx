      ...
      <div className="p-4 sm:p-5">
        <div className="flex items-start gap-3 sm:gap-4">
          ...
          <div className="flex-shrink-0 w-12 sm:w-14 text-center">
            <div className="text-[10px] sm:text-xs font-bold text-blue-600 uppercase">{order.month}</div>
            <div className="text-xl sm:text-2xl font-bold text-gray-900 leading-none mt-0.5">{order.day}</div>
            <div className="text-[10px] sm:text-xs text-gray-400 mt-0.5">{order.year}</div>
          </div>

          {/* Service/Product icon — hidden on very small screens to save space */}
          <div className={`hidden sm:flex w-11 h-11 rounded-xl items-center justify-center flex-shrink-0 ${
            isProduct
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between gap-2 sm:gap-3">
              <div className="min-w-0">
                <h3 className="font-bold text-gray-900 text-sm sm:text-base truncate">{order.title}</h3>
              ...
              {/* Status badge */}
              {isAwaitingClosure ? (
                <span className="inline-flex items-center gap-1 sm:gap-1.5 px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-full text-[10px] sm:text-xs font-semibold border flex-shrink-0 bg-blue-50 text-blue-700 border-blue-200 whitespace-nowrap">
                  <span className="w-1.5 h-1.5 rounded-full bg-blue-500" />
                  Awaiting Closure
                </span>
              ) : (
                <span className={`inline-flex items-center gap-1 sm:gap-1.5 px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-full text-[10px] sm:text-xs font-semibold border flex-shrink-0 whitespace-nowrap ${statusCfg.color}`}>
            ...
            {/* Price + Actions */}
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-gray-50">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                {isCancellable && (
                  <button
                    onClick={onCancel}
                    className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-white border border-red-200 hover:border-red-400 hover:bg-red-50 text-red-600 rounded-xl text-xs sm:text-sm font-semibold transition-all"
                  >
                ...
                {order.canTrack && (
                  <Link href={`/bookings?id=${order.id}`}>
                    <button className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-5 py-2 sm:py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-xs sm:text-sm font-semibold transition-all shadow-sm shadow-blue-200 active:scale-[0.97]">
                ...
                {isPaymentDue && (
                  <Link href={`/bookings/completion?id=${order.id}`}>
                    <button className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-5 py-2 sm:py-2.5 bg-orange-600 hover:bg-orange-700 text-white rounded-xl text-xs sm:text-sm font-semibold transition-all shadow-sm shadow-orange-200 active:scale-[0.97]">
                ...
                {order.hasInvoice && (
                  <button
                    ...
                    className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-white border border-gray-200 hover:border-blue-300 hover:bg-blue-50 text-gray-700 hover:text-blue-700 rounded-xl text-xs sm:text-sm font-semibold transition-all disabled:opacity-60"
                  >
                    {downloadingInvoice
                ...
                {order.canReview && (
                  <button
                    ...
                    className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-white border border-gray-200 hover:border-amber-300 hover:bg-amber-50 text-gray-700 hover:text-amber-700 rounded-xl text-xs sm:text-sm font-semibold transition-all"
                  >
