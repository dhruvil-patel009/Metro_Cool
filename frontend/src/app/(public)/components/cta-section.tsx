...
export function CTASection() {
  const ctaSchema = {
    ...
    provider: { "@type": "LocalBusiness", name: "Metro Cool", url: "https://www.metrocool.com" },
    areaServed: { "@type": "Country", name: "India" },
    description: "Book professional AC repair, installation or browse energy-efficient air conditioners from Metro Cool.",
  }
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-700 rounded-3xl py-16 sm:py-20 px-6 sm:px-12 text-center relative overflow-hidden shadow-2xl shadow-blue-600/20">
