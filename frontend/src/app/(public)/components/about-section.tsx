    ...
    "@graph": [
      {
        ...
        description: "MetroCool provides professional AC repair, installation and industrial cooling services.",
        foundingDate: "2016",
        parentOrganization: { "@type": "Organization", name: "Comfort HVAC Solutions" },
      },
    ],
  }
