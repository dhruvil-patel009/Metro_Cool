    ...
    <AuthGuard>
      <div className="min-h-screen bg-gray-50 font-sans">
        ...
        <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div
            className={`flex justify-center mb-6 transition-all duration-700 ${mounted ? "opacity-100 scale-100" : "opacity-0 scale-50"
              }`}
          >
          ...
          <div
            className={`text-center mb-8 transition-all duration-700 delay-200 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
              }`}
          >
          ...
          <div
            className={`bg-white rounded-xl shadow-sm border border-gray-200 p-6 md:p-8 mb-8 transition-all duration-700 delay-300 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
              }`}
          >
          ...
          <div
            className={`bg-white rounded-xl shadow-sm border border-gray-200 p-6 md:p-8 mb-8 transition-all duration-700 delay-500 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
              }`}
          >
          ...
          <div
            className={`flex flex-col sm:flex-row gap-4 justify-center items-center mb-8 transition-all duration-700 delay-700 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
              }`}
          >
            <Link
              href="/r"
