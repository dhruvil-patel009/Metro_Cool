...
export default function BookingSuccessPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Mock booking data
  const bookingId = "MC-882910"
  const userEmail = "user@example.com"
  const bookingDate = "Oct 24, 2023"
  const bookingDay = "Thursday"
  const bookingTime = "10:00 AM - 11:00 AM"
  const duration = "1 Hour Duration"
  const location = "123 Metro Avenue, Apt 4B"
  const city = "New York, NY 10001"
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <p className="text-gray-600 mb-4">
            We have sent a confirmation email to <span className="font-semibold text-blue-600">{userEmail}</span>
            <br />
