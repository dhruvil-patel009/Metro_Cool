...
export function WorkingView({ onBack, jobId = "1234" }: { onBack: () => void; jobId?: string }) {
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-black text-slate-900 text-xl tracking-tight">TechDash</span>
            </div>
          </div>
          <nav className="hidden md:flex items-center gap-8">
            <span className="text-sm font-bold text-slate-400">Dashboard</span>
            <span className="text-sm font-bold text-[#0891b2] border-b-2 border-[#0891b2] pb-1">Schedule</span>
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                <span className="bg-[#0891b2]/10 text-[#0891b2] text-[10px] font-black px-2 py-0.5 rounded uppercase tracking-widest">
                  Active Job
                </span>
                <span className="text-xs font-bold text-slate-400">Updated 2m ago</span>
              </div>
              <h1 className="text-4xl font-black text-slate-900 tracking-tight">AC Repair: Unit Failure</h1>
          ...
          <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm flex items-center gap-6 min-w-[280px]">
            ...
            <div>
              ...
              <p className="text-3xl font-black text-slate-900 tracking-tighter tabular-nums">{time}</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm space-y-6">
              <div className="space-y-2">
                <h3 className="text-xl font-bold text-slate-900 tracking-tight">Current Step Actions</h3>
              ...
              <Link href={`/technician/jobs/${jobId}/reports`}>
                <Button className="w-full bg-[#0891b2] hover:bg-[#0e7490] text-white py-8 rounded-2xl font-black text-xl gap-3 shadow-lg shadow-cyan-100 transition-all active:scale-[0.98]">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-slate-500 group-hover:text-slate-900">{action.label}</span>
                  </button>
                ))}
              </div>
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                ...
                <div>
                  ...
                  <p className="font-bold text-[#0891b2]">(555) 123-4567</p>
                  <p className="text-sm font-medium text-slate-400">sarah.j@example.com</p>
                </div>
                <div>
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-1">
                    Customer Since
            ...
            <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden">
              <div className="p-6 border-b border-slate-50 flex items-center justify-between">
                ...
                <button className="text-xs font-bold text-[#0891b2] hover:underline">Open in Maps</button>
              </div>
              <div className="p-4 space-y-4">
                <div className="relative aspect-video rounded-2xl overflow-hidden border border-slate-100">
                  <img src="/working-location-map.jpg" alt="Map" className="w-full h-full object-cover" />
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-8 h-8 rounded-full bg-[#0891b2] border-4 border-white shadow-lg relative z-10" />
                    <div className="w-12 h-12 rounded-full bg-[#0891b2]/30 animate-ping absolute" />
                  </div>
                </div>
                <div className="p-4 bg-slate-50 rounded-xl flex items-center justify-between">
                  <span className="text-xs font-bold text-slate-400">Gate Code:</span>
                  <span className="bg-cyan-50 text-[#0891b2] px-3 py-1 rounded-full font-black text-sm border border-cyan-100">
                    #4589
                  </span>
                </div>
              </div>
            ...
            <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden">
              <div className="p-6 border-b border-slate-50">
                <h3 className="text-lg font-bold text-slate-900">Technician Notes</h3>
              </div>
              <div className="p-6 space-y-6">
                <p className="text-slate-600 font-medium leading-relaxed italic border-l-4 border-slate-100 pl-4">
                  "Customer reported loud banging noise when unit starts up. Suspect fan blade issue or loose mount."
                </p>
                <div className="grid grid-cols-3 gap-2">
                  <div className="aspect-square rounded-xl overflow-hidden border border-slate-100">
                    <img src="/unit-photo-1.jpg" alt="Notes" className="w-full h-full object-cover" />
                  </div>
