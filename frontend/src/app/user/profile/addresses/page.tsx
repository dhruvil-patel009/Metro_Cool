        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-9">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      <Link href={`/user/addresses/${addr.id}`} className="flex-1">
                        <Button
                          variant="outline"
              ...
              {/* Add New Card */}
              <Link href="/user/addresses/new" className="bg-gray-50/50 rounded-3xl p-6 border-2 border-dashed border-gray-200 flex flex-col items-center justify-center text-center group cursor-pointer hover:border-blue-300 hover:bg-blue-50/20 transition-all min-h-[340px]">
