...
if (!token) return router.push("/auth/login")
  ...
  try {
    ...
    if (!addr) return router.push("/user/profile/addresses")
...
return ( <div className="min-h-screen bg-gray-50 py-10"> <div className="max-w-2xl mx-auto px-4">
    ...
    <Link href="/user/profile/addresses" className="flex items-center gap-2 text-sm text-gray-600 mb-6 hover:text-blue-600">
