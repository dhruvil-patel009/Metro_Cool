        ...
        <div className="flex min-h-screen">
            ...
            <div className="relative hidden w-1/2 lg:block">
                ...
                <div className="absolute inset-0 z-0">
                    <Image src="/assets/otp-screen.jpg" alt="HVAC Technician at work" fill className="object-cover" priority />
            ...
            <div className="flex w-full items-center justify-center bg-white px-6 py-12 lg:w-1/2">
                <div className="w-full max-w-md">
                    ...
                    {/* Header */}
                    <div className="mb-8">
                        <h2 className="mb-3 text-3xl font-bold text-gray-900">Verify Phone Number</h2>
  ...
  />
                    ...
                    <div className="rounded-lg bg-gray-50 p-4">
                        <div className="flex gap-3">
                            ...
                            <div>
                                <p className="mb-1 text-sm font-semibold text-gray-900">Having trouble?</p>
                                <p className="text-sm text-gray-600">
                                    If you didn't receive the code, check your network connection or contact{" "}
                                    <button className="font-semibold text-blue-600 hover:text-blue-700">support</button>.
                                </p>
                            </div>
                        </div>
                    </div>
